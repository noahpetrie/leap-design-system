...
Each Leap Design System release includes package releases that are
...
| Leap Design System | IBM Design Language | @carbon/elements | carbon-components | carbon-components-react | @carbon/react |
| -------------------- | ------------------- | --------------- | ----------------- | ------------ | ------------ |
