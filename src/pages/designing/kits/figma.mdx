...
The `(v11) Leap Design System` library includes all four Carbon themes,
...
Then in the Libraries modal that appears, find the `(v11) Leap Design System`
...
<Column colMd={4} colLg={4} noGutterSm>
  <ResourceCard
    subTitle="(v11) Leap Design System"
...
Search for **Leap Design System** (B).
...
See the `(v11) Leap Design System` library file.
...
To preview the `(v11) Leap Design System` library, visit the following
view-only link.
