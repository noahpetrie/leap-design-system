...
`Insert → Symbols → Leap Design System` or `IBM Design Language`.
...
From the main menu select **Insert → Symbols → Leap Design System** then
...
From the main menu select **Insert → Text Styles → Leap Design System** to
...
For anyone interested in contributing to the Leap Design System website, or
