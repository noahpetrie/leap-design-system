...
description:
  The Leap Design System is built with official support for React and Web
...
The Leap Design System is built React first, with official support for Web
...
For the Leap Design System to incorporate additional frameworks into our core
