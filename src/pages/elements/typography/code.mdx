...
tokens from the Leap Design System. It also comes with opinionated defaults
...
[Leap Design System website](https://carbondesignsystem.com/elements/typography/type-sets)
.
