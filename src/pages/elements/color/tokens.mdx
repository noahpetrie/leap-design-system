...
Core tokens are global colours that are used across components. They are named
...
Some components have their own specific colour tokens, known as component tokens.
...
To accommodate for the new AI styles, we have introduced a new suite of colour
